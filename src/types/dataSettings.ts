...
export const optionCategory = {
  "trivia_categories": [
    ...
    {"id": '19', "name": "Science: Mathematics"}, {"id": '20', "name": "Mythology"},
    {"id": '21', "name": "Sports"}, {"id": '22', "name": "Geography"}, {"id": '23', "name": "History"},
    {"id": '24', "name": "Politics"}, {"id": '25', "name": "Art"},
    {"id": '26', "name": "Celebrities"}, {"id": '27', "name": "Animals"},
